...
export default function Main(props) {
  ...
  function updateEverything(level, displayName, credits, skillpoints, IntelligenceLvl, AgilityLvl, DisciplineLvl, EmotionsLvl, StrengthLvl, Ixp, Axp, Dxp, Exp, Sxp, Squantity, Vquantity, Wquantity,width) {
    setlevel(level);
